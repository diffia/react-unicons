...
const UilWordpressSimple = (props) => {
  ...
  return React.createElement('svg', {
    ...
    height: size,
    viewBox: '0 0 24 24',
    className: 'iconscout_react_unicons iconscout_react_unicons_uil-wordpress-simple',
    ...otherProps
...
UilWordpressSimple.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};

UilWordpressSimple.defaultProps = {
  color: 'currentColor',
  size: '24',
};

export default UilWordpressSimple;