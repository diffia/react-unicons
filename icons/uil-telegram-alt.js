...
const UilTelegramAlt = (props) => {
  ...
  return React.createElement('svg', {
    ...
    height: size,
    viewBox: '0 0 24 24',
    className: 'iconscout_react_unicons iconscout_react_unicons_uil-telegram-alt',
    ...otherProps
...
UilTelegramAlt.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};

UilTelegramAlt.defaultProps = {
  color: 'currentColor',
  size: '24',
};

export default UilTelegramAlt;